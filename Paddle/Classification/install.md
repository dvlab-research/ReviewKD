...
---
This tutorial introduces how to install PaddlePaddle.

## 1. Install PaddlePaddle

`PaddlePaddle 2.0` or later is required here. You can use the following steps to install PaddlePaddle.
...
Docker is recomended to run the program, for more detailed information about docker and nvidia-docker, you can refer to the [tutorial](https://www.runoob.com/docker/docker-tutorial.html).
